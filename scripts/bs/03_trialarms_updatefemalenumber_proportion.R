...
studysheet <- readRDS('data/bs/processed/studysheet.rds')
glimpse(studysheet)

# Read the TrialArms sheet
trialarms <- readRDS('data/bs/processed/trialarms.rds')
glimpse(trialarms)
...
#####################################################################################
saveRDS(studysheet_trialarms, file = 'data/bs/processed/studysheet_trialarms_updated.rds')
