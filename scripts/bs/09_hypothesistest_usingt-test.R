...
##############################
write_csv(bmi_t_test, 'output/bs/tables/bmi_t-test_results.csv')
...
##############################
write_csv(sbp_t_test, 'output/bs/tables/sbp_t-test_results.csv')
...
# Save the sbp_t-test results-----
##############################
write_csv(dbp_t_test, 'output/bs/tables/dbp_t-test_results.csv')
