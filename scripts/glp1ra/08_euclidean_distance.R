...
ggsave(filename = "output/glp1ra/figures/datadrivenvis/euc_dist/bmi_sbp_dbpEucdist.jpeg",
...
ggsave(filename = "output/glp1ra/figures/datadrivenvis/euc_dist/bmi_sbpEucdist.jpeg",
...
ggsave(filename = "output/glp1ra/figures/datadrivenvis/euc_dist/bmi_dbpEucdist.jpeg",
