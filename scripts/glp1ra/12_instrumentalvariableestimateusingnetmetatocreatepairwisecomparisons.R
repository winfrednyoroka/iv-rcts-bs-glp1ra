...
################################################################################
# Save the sbp_bmi and dbp_bmi at 6 months,
# 12-24 months to be used in metaregression
################################################################################
saveRDS(sbp_bmi_6m, 'data/glp1ra/processed/sbp_bmi_6m.rds')

saveRDS(dbp_bmi_6m, 'data/glp1ra/processed/dbp_bmi_6m.rds')
sbp_bmi_12_24 = subset(sbp_bmi, time_group == "12-24 months")
saveRDS(sbp_bmi_12_24,'data/glp1ra/processed/sbp_bmi_12_24m.rds')
dbp_bmi_12_24 = subset(dbp_bmi, time_group == "12-24 months")
saveRDS(dbp_bmi_12_24,'data/glp1ra/processed/dbp_bmi_12_24m.rds')
