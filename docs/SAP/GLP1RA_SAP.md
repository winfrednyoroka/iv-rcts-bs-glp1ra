...
a.	Conduct a pairwise random-effects/fixed effects meta-analysis using the metafor package for SBP, DBP and hypertension (prevalence, remission, antihypertensive medication use where possible).   
